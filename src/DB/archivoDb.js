...
const url = 'mongodb+srv://agumartinez1209:<password>@cluster0.druz5we.mongodb.net/testdesafio?retryWrites=true&w=majority';
...
class ArchivoDB {
  ...
  cerrar() {
    mongoose.disconnect(err => { console.log('desconectado') });
  }
}
